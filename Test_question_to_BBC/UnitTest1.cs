...
namespace Tests
{
    public class Tests
    {
        ...
        public void Test1()
        {
            ...
            StringReturnResult stringReturnResult = new StringReturnResult(driver);
            ...
            //Console.WriteLine("first: " + lipsums[0]);
            ...
            //bBC_Homepage.fillQuestionTextarea.SendKeys(string[] lipsums[0].ToString );
